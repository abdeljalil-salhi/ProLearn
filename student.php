...
<head>
    ...
    <link rel="stylesheet" href="styles/style-student.css"/>
        ...
        <div class="box boxcenter">
            <div class="spaces">
                <div class="spacespadding">
                    <div class="header-student hr">
                        <center>
                            <b class="header-student-b">Espace &Eacute;l&egrave;ves</b><br>
                            <img src="ressources/icons/hd/student.png" height=150 draggable="false" alt="Espace Professeurs"/>
                        </center>
                    </div>
                    <form method="POST" action="student/login.php" id="studentlogin">
                        <center>
                            <input type="text" name="username" class="input-student pr" placeholder="Identifiant proLearn" autocomplete="false" required/><br>
                            <input type="password" name="password" class="input-student" id="password" placeholder="Mot de passe proLearn" autocomplete="false" required/><br>
                            <input type="checkbox" class="checkbox-student pr" onclick="toggleVisibility()"><small class="showpassword"> Montrer le mot de passe</small><br>
                        </center>
                    </form>
                </div>
                <button type="submit" form="studentlogin" class="submit-student" value="Se connecter">Se connecter</button>
            </div>
        </div>
    </div>
    <!--RESSOURCES-->
